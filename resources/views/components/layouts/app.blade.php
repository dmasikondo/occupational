        ...
        <div class="flex flex-col justify-between mt-10">
          <aside>
            <ul class="mt-2">
              ...
              <li>
                <a class="flex items-center px-4 py-2 mt-5 text-gray-700 hover:bg-gray-200 rounded-md bg-gray-50 @if(request()->routeIs('create-project')||request()->routeIs('show-project') ||request()->routeIs('show-projects')) bg-gray-50 border-indigo-500 border-l-4 @endif" href="/projects/">
